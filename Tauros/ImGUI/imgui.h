...
struct ImVec4
{
	...
	ImVec4(std::string hexColor)
	{
		auto length = hexColor.length();
		if ((length == 7 || length == 9) && hexColor[0] == '#')
			hexColor = hexColor.substr(1, --length);

		if (length == 6)
		{
			x = GetFloatByHex(hexColor.substr(0, 2));
			y = GetFloatByHex(hexColor.substr(2, 2));
			z = GetFloatByHex(hexColor.substr(4, 2));
			w = 1.f;
		}
		else if (length == 8)
		{
			...
			y = GetFloatByHex(hexColor.substr(2, 2));
			z = GetFloatByHex(hexColor.substr(4, 2));
			w = GetFloatByHex(hexColor.substr(6, 2));
		}
		else
		{
			x = y = z = w = 0.f;
	...
	ImVec4(std::string hexColor, float _w)
	{
		w = _w;
		auto length = hexColor.length();
		if (length == 7 && hexColor[0] == '#')
			hexColor = hexColor.substr(1, --length);
...
#endif
private:
	float GetFloatByHex(std::string hex)
	{
		if (hex.length() != 2)
			return 0.f;
		...
		// First letter
		if (hex[0] == '1') total += 16.f / 255.f;
		else if (hex[0] == '2') total += 32.f / 255.f;
		else if (hex[0] == '3') total += 48.f / 255.f;
		else if (hex[0] == '4') total += 64.f / 255.f;
		else if (hex[0] == '5') total += 80.f / 255.f;
		else if (hex[0] == '6') total += 96.f / 255.f;
		else if (hex[0] == '7') total += 112.f / 255.f;
		else if (hex[0] == '8') total += 128.f / 255.f;
		else if (hex[0] == '9') total += 144.f / 255.f;
		else if (hex[0] == 'a' || hex[0] == 'A') total += 160.f / 255.f;
		else if (hex[0] == 'b' || hex[0] == 'B') total += 176.f / 255.f;
		else if (hex[0] == 'c' || hex[0] == 'C') total += 192.f / 255.f;
		else if (hex[0] == 'd' || hex[0] == 'D') total += 208.f / 255.f;
		else if (hex[0] == 'e' || hex[0] == 'E') total += 224.f / 255.f;
		else if (hex[0] == 'f' || hex[0] == 'F') total += 240.f / 255.f;

		// Seconds letter
		if (hex[1] == '1') total += 1.f / 255.f;
		else if (hex[1] == '2') total += 2.f / 255.f;
		else if (hex[1] == '3') total += 1.f / 85.f;
		else if (hex[1] == '4') total += 4.f / 255.f;
		else if (hex[1] == '5') total += 1.f / 51.f;
		else if (hex[1] == '6') total += 2.f / 85.f;
		else if (hex[1] == '7') total += 7.f / 255.f;
		else if (hex[1] == '8') total += 8.f / 255.f;
		else if (hex[1] == '9') total += 3.f / 85.f;
		else if (hex[1] == 'a' || hex[0] == 'A') total += 2.f / 51.f;
		else if (hex[1] == 'b' || hex[0] == 'B') total += 11.f / 255.f;
		else if (hex[1] == 'c' || hex[0] == 'C') total += 4.f / 85.f;
		else if (hex[1] == 'd' || hex[0] == 'D') total += 13.f / 255.f;
		else if (hex[1] == 'e' || hex[0] == 'E') total += 14.f / 255.f;
		else if (hex[1] == 'f' || hex[0] == 'F') total += 3.f / 51.f;
...
namespace ImGui
{
	...
	IMGUI_API bool          Combo(const char* label, int* current_item, std::vector<std::string> items, int popup_max_height_in_items = -1);

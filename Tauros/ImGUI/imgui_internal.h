...
namespace ImGui
{
    ...
    IMGUI_API void          RenderFrame(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool border = true, float rounding = 0.0f, int rounding_corners = ImDrawCornerFlags_All);
    ...
    IMGUI_API bool          ButtonEx(const char* label, const ImVec2& size_arg = ImVec2(0,0), ImGuiButtonFlags flags = 0, int rounding_corners = ImDrawCornerFlags_All);
